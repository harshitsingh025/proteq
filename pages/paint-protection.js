        ...
        <div className="paintWrapper">
          ...
          <section className="secCategory">
            ...
            <div className="tab-content" id="nav-tabContent">
              ...
              <div className="tab-pane fade" id="nav-series3" role="tabpanel" aria-labelledby="nav-series3-tab">
                <div className="container">
                  <img src="img/2.0seriesText.svg" className="img-fluid m-md-5" />     
                  <div className="row justify-content-center">
                    <div className="col-xl-5 col-lg-6 col-md-6 col-sm-12">
              ...
              <div className="tab-pane fade" id="nav-series5" role="tabpanel" aria-labelledby="nav-series5-tab">
                <div className="container">
                  <img src="img/2.0seriesText.svg" className="img-fluid m-md-5" />     
                  <div className="row justify-content-center">
                    <div className="col-xl-5 col-lg-6 col-md-6 col-sm-12">
                ...
                <div className="row justify-content-center productVideoWrapper">
                  <div className="col-xl-7 col-lg-6 col-md-6">
                    <div className="productVideo">
                      ...
                      <button className="playBtn"><img src="img/play-button.svg" /></button>
                    </div>
                  </div>
                </div>
              </div>
